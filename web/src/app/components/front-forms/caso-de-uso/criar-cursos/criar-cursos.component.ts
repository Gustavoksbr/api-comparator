...
export class CriarCursosComponent {
  ...
  formulario: FormGroup = new FormGroup({
    ...
    nivel: new FormControl('INICIANTE'),
    ...
    instrutorNome: new FormControl('', [Validators.maxLength(60)]),
    instrutorEmail: new FormControl('', [Validators.email]),
    instrutorBio: new FormControl('', [Validators.maxLength(160)]),
    modulosTexto: new FormControl(''),
  });
}
